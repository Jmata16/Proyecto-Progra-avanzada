      ...
      value: function handleUserInputErrors(opts) {
        ...
        if (config.chart.type === 'bar') {
          if (config.tooltip.shared) {
            ...
            if (!config.tooltip.followProductor) {
              console.warn('followProductor option in shared columns cannot be turned off.');
              config.tooltip.followProductor = true;
            }
          }
        }
  ...
  function () {
    ...
    _createClass(Utils, [{
      ...
      value: function getNearestValues(_ref) {
        ...
        }); // if X axis type is not category and tooltip is not shared, then we need to find the Productor position and get the nearest value
  ...
  function () {
    ...
    _createClass(Position, [{
      ...
      value: function moveTooltip(cx, cy) {
        ...
        if (w.config.tooltip.followProductor) {
    ...
    _createClass(Intersect, [{
      ...
      value: function handleHeatTooltip(_ref) {
        ...
        if (e.target.classList.contains('apexcharts-heatmap-rect')) {
          ...
          if (ttCtx.w.config.tooltip.followProductor) {
            var elGrid = ttCtx.getElGrid();
